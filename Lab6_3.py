# Lab6 CartPole with Q Network
# success rate should be really poor such as total score of 15, 25, etc.
...
with tf.Session() as sess:
	...
	reward_sum = 0
	while True:
		# env.render() # comment this line when you have a problem in rendering
